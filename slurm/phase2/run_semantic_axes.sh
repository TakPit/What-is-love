...
#SBATCH --job-name="run_semantic_axes"
#SBATCH --account=3192105
#SBATCH --partition=stud
#SBATCH --qos=stud
#SBATCH --chdir=/home/3192105/nlp_project
#SBATCH --output=/home/3192105/nlp_project/logs/out/run_semantic_axes_%j.out
#SBATCH --error=/home/3192105/nlp_project/logs/err/run_semantic_axes_%j.err
...
OUTPUT_ROOT="results/phase2/semantic_axes"
NEIGHBORS_K=15
PAIR_MODE="targets_only"
PAIR_WORDS_FILE=""
OVERWRITE=1

CMD=(
  python src/phase2/run_semantic_axes.py
  --config "$CONFIG"
...
if [[ -n "$PAIR_WORDS_FILE" ]]; then
  CMD+=(--pair-words-file "$PAIR_WORDS_FILE")
fi
